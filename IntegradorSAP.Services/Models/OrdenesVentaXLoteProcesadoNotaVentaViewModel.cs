...
namespace IntegradorSAP.Data.Models
{
    ...
    public class OrdenesVentaXLoteProcesadoNotaDebito
    {
        ...
        //value.CTK_DocEntryRel = resFact.DocEntry.ToString();
        //                        value.CTK_DocNumRel = DocNum.ToString();
        ...
        //public string DocumentSubType { get; set; }ss
        ...
        public string CTK_DocEntryRel { get; set; }
        public string CTK_DocNumRel { get; set; }
    ...
    //    public object U_EXX_FPAGO_VENTAS { get; set; }
        ...
        public List<DocumentlineVtaLoteProcesadoNotaDebito> Line { get; set; }
    ...
    public class DocumentlineVtaLoteProcesadoNotaDebito
    {
    ...
    //public class EXX_DOCUM_LEG_INTER
    //{
    //    public long U_ULT_SECUEN { get; set; }
