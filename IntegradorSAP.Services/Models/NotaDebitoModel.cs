...
namespace IntegradorSAP.Data.Models
{
    ...
    public class NotaDebitoCreateModel
    {
    ...
    //    public decimal DocRate { get; set; }
        ...
        public List<DocumentlineNotaVentaModel> DocumentLines { get; set; }
    ...
    public class NotaDebitoRespCreateModel
    {
        public long DocNum { get; set; }
        public string DocType { get; set; }
        //public string HandWritten { get; set; }
    ...
    public class DocumentlineNotaVentaModel
    {
    ...
    public class DocumentlineNotaVentaCreateModel
    {
        //public int LineNum { get; set; }
        //public string ItemCode { get; set; }
        //public string ItemDescription { get; set; }
    ...
    public class DocumentlineNotaVentaRespModel
    {
        public int LineNum { get; set; }
        public string ItemCode { get; set; }
        public string ItemDescription { get; set; }
