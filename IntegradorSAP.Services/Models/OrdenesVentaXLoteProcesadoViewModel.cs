...
namespace IntegradorSAP.Data.Models
{
    ...
    public class OrdenesVentaXLoteProcesado
    {
        ...
        public long U_EXX_FPAGO_VENTAS { get; set; }
        ...
        public List<DocumentlineVtaLoteProcesado> Line { get; set; }
    ...
    public class DocumentlineVtaLoteProcesado
    {
