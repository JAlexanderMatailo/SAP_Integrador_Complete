...
namespace IntegradorSAP.Data.Models
{
    ...
    public class OrdenVentaXNotaDebito
    {
     ...
     //  public decimal DocRate { get; set; }
        ...
        public DocumentlineVtaNotaDeb[] DocumentLines { get; set; }
        ...
        public TaxextensionNotaDebitoLote TaxExtension { get; set; }
        public AddressextensionNotaDebitoLote AddressExtension { get; set; }
    }


    public class TaxextensionNotaDebitoLote
    {
    ...
    public class AddressextensionNotaDebitoLote
    {
    ...
    public class OrdenVentaNotaDebitoLote
    {
    ...
    public class DocumentlineVtaNotaDeb
    {
